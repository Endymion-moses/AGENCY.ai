...
const Hero = () => {
  return (
    ...
    p-1.5 pr-4 rounded-full'>
        ...
        >creating meaningful connections and turning ideas into interactive  digital experiences.
        </p>

        <div className='relative'>
          <img src={assets.hero_img} className="w-full max-w-6xl"alt="" />
          <img src={assets.bgImage1} className='absolute -top-40 -right-40 sm:-top-100
